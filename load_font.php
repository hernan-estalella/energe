...
function install_font_family($dompdf, $fontname, $normal, $bold = null, $italic = null, $bold_italic = null) {
  ...
  $patterns = array(
    "black"        => array("_Black","-Black"),
    "black_italic" => array("_Black_Italic","-BlackItalic"),
    "bold"        => array("_Bold","-Bold", "b", "B", "bd", "BD"),
    "bold_italic" => array("_Bold_Italic","-BoldItalic"),
    "extra_bold"        => array("_Extra_Bold","-ExtraBold"),
    "extra_bold_italic" => array("_Extra_Bold_Italic","-ExtraBoldItalic"),
    "extra_light"        => array("_Extra_Light","-ExtraLight"),
    "extra_light_italic" => array("_Extra_Light_Italic","-ExtraLightItalic"),
    "italic"      => array("_Italic", "-Italic", "i", "I"),
    "light"        => array("_Light","-Light"),
    "light_italic" => array("_Light_Italic","-LightItalic"),
    "medium"        => array("_Medium","-Medium"),
    "medium_italic" => array("_Medium_Italic","-MediumItalic"),
    "semi_bold"        => array("_SemiBold","-SemiBold"),
    "semi_bold_italic" => array("_SemiBold_Italic","-SemiBoldItalic"),
    "thin"        => array("_Thin","-Thin"),
    "thin_italic" => array("_Thin_Italic","-ThinItalic"),
  );
  ...
  $fonts = compact("normal", "black","black_italic","bold","bold_italic","extra_bold","extra_bold_italic","extra_light","extra_light_italic","italic","light","light_italic","medium","medium_italic","semi_bold","semi_bold_italic","thin","thin_italic");
  $entry = array();

...
<body>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="40" class="top-border right-border bottom-border">
          <img src="{{public_path()}}/img/charts/radiation_{{$project->id}}.png" alt="ENERGE" width="100%">
        </td>
      </tr>
      <tr>
  ...
  <table>
    <tbody>
      ...
      <tr>
        <td colspan="100">
          <img src="{{public_path()}}/img/charts/cashflow_{{$project->id}}.png" alt="ENERGE" width="100%">
        </td>
      </tr>
    </tbody>
  </table>
